...
var BezierSeparation2 = (function (_super) {
    __extends(BezierSeparation2, _super);
    function BezierSeparation2() {
        _super.apply(this, arguments);
        this.drawButton = null;
        this.curveDrawed = false;
        this.curveSeparated = false;
    }
    BezierSeparation2.prototype.computeBezierPoint = function (count, i, u, p) {
        if (count === 0) {
            return p[i];
        }
    ...
    BezierSeparation2.prototype.drawBezierCurve = function (points) {
    ...
    BezierSeparation2.prototype.createPoint = function (point) {
        var _this = this;
    ...
    BezierSeparation2.prototype.renderPoints = function () {
    ...
    BezierSeparation2.prototype.removePoint = function (selectedPoint) {
        this.sIndex = selectedPoint;
        this.seperateCurve();
    };
    BezierSeparation2.prototype.seperateCurve = function () {
        this.clearCanvas();
        var p1 = new Array();
        var p2 = new Array();

class DeCasteljau implements IDeCasteljau<Point> {
    ...
    constructor() {
        ...
        this.addPointBtn.innerHTML = "Dodaj toèku";
        ...
        this.computeBtn.innerHTML = "Izraèunaj";
    ...
    showResult(rPoint: Point): void {
        ...
        formLabel.innerHTML = "Rezultantna toèka";
    ...
    addPoint(): void {
        ...
        if (this.pointsCount !== 0) {
            ...
            this.u = Number($("#u").val());
            if (this.u > 1) {
                alert("Parametar u ne smije biti veæi od 1!");
                return;
            }
